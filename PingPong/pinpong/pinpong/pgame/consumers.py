...
class PingPongConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        self.pad_num = len(connected_players[self.room_group_name]['channels'])
